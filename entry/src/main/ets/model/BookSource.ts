...
export function parseBookSource(json: any): BookSource {
  ...
  return {
    ...
    ruleToc: toRuleString(typeof json.ruleToc === 'string' ? json.ruleToc : (json.ruleToc || {}).chapterList || ''),
    ruleTocTitle: toRuleString(json.ruleTocTitle || (typeof json.ruleToc === 'object' ? (json.ruleToc || {}).chapterName : '') || ''),
    ruleTocUrlItem: toRuleString(json.ruleTocUrlItem || (typeof json.ruleToc === 'object' ? (json.ruleToc || {}).chapterUrl : '') || ''),
    ...
    ruleBookInfoTocUrl: json.ruleBookInfoTocUrl || (json.ruleBookInfo || {}).tocUrl || '',
